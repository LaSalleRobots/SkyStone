  ...
  public void runOpMode() {
    ...
    while (opModeIsActive()) {
      ...
      if (gamepad1.dpad_down) {
        ...
        if (command.equals("moveForwards")) {
          robot.moveForwards();
        } else if (command.equals("moveBackwards")) {
          robot.moveBackwards();
        } else if (command.equals("moveLeft")) {
          robot.moveLeft();
        } else if (command.equals("moveRight")) {
          robot.moveRight();
        } else if (command.equals("moveBackwardsLeft")) {
          robot.moveBackwardsLeft();
        } else if (command.equals("moveBackwardsRight")) {
          robot.moveBackwardsRight();
        } else if (command.equals("moveForwardsLeft")) {
          robot.moveForwardsLeft();
        } else if (command.equals("moveForwardsRight")) {
          robot.moveForwardsRight();
        } else if (command.equals("rotateLeft")) {
          robot.rotateLeft();
        } else if (command.equals("rotateRight")) {
          robot.rotateRight();
        } else if (command.equals("toggleFunc")) {
